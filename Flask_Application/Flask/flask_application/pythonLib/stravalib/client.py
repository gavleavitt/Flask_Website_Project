...
class Client(object):
    ...
    def authorization_url(self, client_id, redirect_uri, approval_prompt='auto',
        ...
        """
        Get the URL needed to authorize your flask_application to access a Strava user's information.
        ...
        :param state: An arbitrary variable that will be returned to your flask_application in the redirect URI.
        :type state: str
    ...
    def deauthorize(self):
        """
        Deauthorize the flask_application. This causes the flask_application to be removed
    ...
    def create_subscription(self, client_id, client_secret, callback_url,
        ...
        :param client_id: flask_application's ID, obtained during registration
        :type client_id: int

        :param client_secret: flask_application's secret, obtained during registration
        :type client_secret: str
    ...
    def list_subscriptions(self, client_id, client_secret):
        """
        List current webhook event subscriptions in place for the current flask_application.
