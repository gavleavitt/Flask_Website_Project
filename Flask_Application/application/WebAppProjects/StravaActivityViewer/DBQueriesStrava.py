...
def createStravaPublicActTopoJSON():
    """
    Creates a local TopoJSON file containing all stored Strava Activities. A local file is used to speed up response
    time, as generating the file may take a few seconds. This function is called on server start and whenever a
    new subscription update adds a new activity to the database. The local file is overwritten on each update.
    Returns
    -------
    Nothing. Creates a local JSON file
    """
